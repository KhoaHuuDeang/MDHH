  ...
  return (
    <div className="group space-y-6 rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-sm transition-all duration-300 ease-[cubic-bezier(.25,.8,.25,1)] hover:shadow-md">
      ...
      <div className="flex items-center gap-3">
        <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-[#386641]/20 bg-[#F0F8F2] text-[#386641] transition-opacity duration-300 group-hover:opacity-80">
