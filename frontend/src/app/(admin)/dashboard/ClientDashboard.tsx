    ...
    <div className="flex-1 p-4 sm:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-2xl">{analytics.activeUsers || 0}</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-xl font-semibold mb-4">{t('admin.disabledUsers')}</h3>
          <p className="text-2xl">{analytics.disabledUsers || 0}</p>
        </div>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{analytics.recentActivity.newUploads || 0}</p>
            </div>
            <div>
              <p className="text-gray-500">{t('admin.comments')}</p>
              <p className="text-2xl font-bold">{analytics.recentActivity.newComments || 0}</p>
            </div>
          </div>
        </div>
      )}

      {analytics.usersByRole && Array.isArray(analytics.usersByRole) && (
        <div className="bg-white p-6 rounded-lg shadow">
